...
const PricingSection = () => {
  const pumpPrices = [
    ...
    },
    {
      ...
      image: truckImage,
      prices: [
        { volume: "Volume 1-25 M³", price: "Rp 6.500.000" },
        { volume: "Volume 25-50 M³", price: "Rp 6.800.000" },
        { volume: "Volume 51-75 M³", price: "Rp 7.000.000" },
        { volume: "Volume 76-100 M³", price: "Rp 7.200.000" },
      ],
    },
  ];
...
Mohon info ketersediaan dan harga untuk Pompa Super Long Boom. Terima kasih.`;
  ...
  return (
    <section id="harga" className="py-16 md:py-24 lg:py-32 bg-gray-light">
      <Container>
